...
As mentioned at the beginning, the activity is quite different across the nine days.
...
Drowzee seems to be the most common (or one of the most common) Pokemon in my city because during those days I captured a total of 59, or 19.86% if it is compared against the rest. Followed by Drowzee there are 54 Pidgey (18.18%), and in the third position, Rattata, with a total of 41 captures (13.80%).
...
But what's in between them? Well, let's see.
...
or Pokemon whose CP are more than 1.5 times the third quartile, which is 238.0.
...
The figure below shows a detailed view the CP for each Pokemon, with the highest ones
...
I was leveling up continuously.
...
To further check the increase of CP per day, the next two plots show the
...
Pokestops during the nine days of the experiment, resulting in a considerable amount
of items - this part is about those items. What's the total of items? How did
they change overtime? How are they distributed? These are my main questions.
...
with a final counter of 546 or 61.62%, a median of 2 per stop, a mean of 2.02, and
a maximum of 5, meaning that one Pokestop dropped 5 Pokeballs. On the other hand,
Hyper Potion was the least common item; just 7 of them were acquired (0.79%).
...
we can clearly see the bold line that states the median, however the second one
...
the first day (with the exception of the third one), the percentage of Potions decreased, while the number of Super and Hyper Potions incremented. However I wouldn't call this a definitive conclusion due to the small data sample.
